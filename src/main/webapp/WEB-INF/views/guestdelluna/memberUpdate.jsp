...
<body>
	...
	<form action="${root}/guestdelluna/memberUpdateOk.do" method="post"
		name="createForm" class="form-horiaontal"
						...
						<div class="form-group">
							...
							<div class="right">
								<dl class="phone">
									<dt>
										<label for="Phone"
											style="margin-left: 20rem; margin-top: 2rem;">휴대폰 번호
										</label>
									</dt>
									<dd>
										<div class="inp">
											<input class="form-control" type="tel" id="phone"
												name="phone" value="" required maxlength="11" placeholder=""
												title="휴대 전화 번호" style="width: 30rem; margin-left: 20rem;">
										</div>
									</dd>
								</dl>
							</div>
							...
							<div>
								<dl class="memInfo" style="margin-top:-2rem">
									...
									<dd>
										<div class="inp">
											<textarea class="form-control" style="margin-left: 20rem;" rows="6" cols="65"
