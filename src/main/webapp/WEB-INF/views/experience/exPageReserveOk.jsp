	...
	<div style="width: 70rem; height: auto; margin: 0 auto; /* border: 0.02rem solid black; */ ">
		...
		<div align="center">
			...
			<div style="margin: 5rem; width: 60rem; /* border: 0.1rem solid red; */ height: auto; ">
				<div style="border: 0.05rem solid #ffa50040; width: 40rem; height: auto; padding: 3rem;">
					...
					<c:if test="${imp_uid ==null}">
						...
						<div id="reserveCode"  style="width: 20rem; margin-left: 10rem; text-align: left; margin-top: 2rem;">${experienceDto.exAccount}</div>
					</c:if>
					
					<div style="width: 10rem; float: left; font-weight: bold; margin-top: 2rem;">결제금액</div>
					<div id="payment" style="width: 20rem; margin-left: 10rem; text-align: left; margin-top: 2rem;"> ${exReserveDto.exPayment}</div>
