			...
			<ul class="nav navbar-nav navbar-right" style="margin-right: 5rem;">
				...
				<c:if test="${memberLevel != null}">
					...
					<li class="nav-item"><a class="nav-link"
						href="${root}/experience/exPage.do?exCode=27">체험 페이지</a></li>
					<li class="nav-item"><a class="nav-link"
         ...
         <ul class="nav navbar-nav navbar-right" style="margin-right: 5rem;">
	            ...
	            <c:if test="${memberLevel != null}">
					...
					<c:if test="${memberLevel =='Host'}">
						<li class="nav-item"><a class="nav-link"
							href="${root}/experience/exHost.do">체험 등록하기</a></li>
					</c:if>

					<li class="nav-item"><a class="nav-link"
						href="${root}/guestdelluna/zzimlist.do">장바구니</a></li>
					<li class="nav-item"><a class="nav-link"
					  ...
					  -->
						...
						<li class="nav-item dropdown"><a
							...
							<div class="dropdown-menu">
								<a class="dropdown-item" href="${root}/admin/experienceList.do">체험
									관리</a> <a class="dropdown-item" href="${root}/admin/houseList.do">게스트하우스
									관리</a> <a class="dropdown-item" href="${root}/admin/memberList.do">회원관리</a>
							</div></li>
					</c:if>
										...
										<div>
													...
													<div class="loginBox">
														<div class="inp" align="center">
															<button type="button" class="btn btn-warning"
																...
																onclick="kakaoLogin()" value="카카오 로그인">카카오 로그인</button>
											...
											<div>
												<div class="modal-footer"
													...
													<a style="font-size: 1rem; margin-right: 2rem;">아직 회원이
														아니신가요?</a>
