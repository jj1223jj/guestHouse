...
function setHouseList(jsonHouseList){
	var house=JSON.parse(jsonHouseList).houseJson;
	for(var i=0;i<house.length;i++){
		$(".houseContainer").prepend('<div class="house">' +
									 '		<div class="_gig1e7">' +
									 '			<div class="_ylefn59">' +
									 ...
									 '							<div class="swiper-slide"><img style="max-width:100%; height:auto;" alt="img loading" src="'+root+'/image/house2.png"/></div>' +
									 '							<div class="swiper-slide"><img style="max-width:100%; height:auto;" alt="img loading" src="'+root+'/image/house3.png"/></div>' +
									 '						</div>' +
									 '' +
...
function heart(memberCode){
	if(memberCode!='') {
		$("._heartButton").click(function(){
			var heart=$(this).children().children();
			var data;
