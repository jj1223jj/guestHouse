...
public class SearchDto {
	...
	public SearchDto(int houseCode, int memberCode, String houseName, String zipCode, String explain, int bath,
			String etc, String checkIn, String checkOut, String necessary, String wifi, String washer, String hotWater,
			...
			String detailAddress, String local, String houseImgName, String houseImgPath, String houseImgSize,
			String approvalStatus, String bank, int account, int people, int bed, int price, Date houseRegDate) {
	...
	public String toString() {
		return "SearchDto [houseCode=" + houseCode + ", memberCode=" + memberCode + ", houseName=" + houseName
				...
				+ ", local=" + local + ", houseImgName=" + houseImgName + ", houseImgPath=" + houseImgPath
				+ ", houseImgSize=" + houseImgSize + ", approvalStatus=" + approvalStatus + ", bank=" + bank
				+ ", account=" + account + ", people=" + people + ", bed=" + bed + ", price=" + price
				+ ", houseRegDate=" + houseRegDate + "]";
	}
