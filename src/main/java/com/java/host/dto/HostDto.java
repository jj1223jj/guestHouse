...
public class HostDto {
	...
	public String toString() {
		return "HostDto [houseCode=" + houseCode + ", memberCode=" + memberCode + ", houseName=" + houseName
				+ ", explain=" + explain + ", bath=" + bath + ", etc=" + etc + ", checkInTime=" + checkInTime
				+ ", checkOutTime=" + checkOutTime + ", necessary=" + necessary + ", wifi=" + wifi + ", washer="
				...
				+ ", autoJibunAddress=" + autoJibunAddress + ", latLng=" + latLng + ", detailAddress=" + detailAddress
